...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50  text-primary-foreground backdrop-blur-xl  rounded-2xl p-2 w-[92%] max-w-[600px]">
        ...
        {isMobile ? (
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Logo */}
            <div className="p-2 relative  rounded-full h-[50px] w-[50px]">
              <Link
                href="/"
                className="flex-1   text-center transform transition-transform duration-300 hover:scale-105"
              >
                <Brand cal />
              </Link>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/"
              className="flex-1 transform transition-transform duration-500 hover:scale-105"
            >
              <Brand />
            </Link>
      ...
      >
        {/* Menu Sheet */}
        <div
          className={`fixed left-0 top-0 h-full w-80 max-w-full bg-primary text-primary-foreground shadow-2xl z-50 transform transition-all duration-500 ease-out ${
            showMenu ? "translate-x-0 opacity-100" : "-translate-x-full"
          }`}
